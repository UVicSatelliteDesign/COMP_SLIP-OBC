...
extern SPI_HandleTypeDef hspi3; // SPI handle definition for accelerometer --sensors
...
void init_sensors() {
    ...
    MX_SPI3_Init(); // Accelerometer SPI initialisation
    MX_SPI4_Init(); // Gyroscope SPI initialisation
}
